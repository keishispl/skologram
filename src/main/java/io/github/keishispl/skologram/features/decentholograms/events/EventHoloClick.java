package io.github.keishispl.skologram.features.decentholograms.events;
...
public class EventHoloClick extends SkriptEvent {
    ...
    static{
        if (Bukkit.getServer().getPluginManager().isPluginEnabled("DecentHolograms")){
            Skript.registerEvent("DecentHolograms - Click", EventHoloClick.class, HologramClickEvent.class,
                            "decenthologram click"
                    )
                    .description("Called when a decenthologram gets clicked.")
                    .examples("on decenthologram click:", "\tbroadcast \"%player% clicked %event-decenthologram%\"")
                    .since("1.0")
