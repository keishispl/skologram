...
@Examples({
        "hide decenthologram named \"hologram\" from all players",
        "show decenthologram named \"hologram\" to player(\"Kacey__\")"
})
@Since("1.0")
...
public class EffectHoloVisibility extends Effect {
    ...
    static {
        Skript.registerEffect(EffectHoloVisibility.class,
                "(hide) %decentholograms% from %players%",
                "(show|reveal) %decentholograms% to %players%"
        );
    }
    ...
    public @NotNull String toString(@Nullable Event event, boolean debug) {
        return "decenthologram visibility for player";
    }
