...
@Examples({
        "set line 1 of decenthologram \"test\" to \"hi\""
})
@Since("1.0")
    ...
    static{
        if (Bukkit.getServer().getPluginManager().isPluginEnabled("DecentHolograms")){
            Skript.registerEffect(EffectHoloEditLine.class,
                    "add [line] of [decenthologram] %decentholograms% to %string%",
                    "remove [line] %integer% of [decenthologram] %decentholograms%",
                    "create line from [page] %integer% of [decenthologram] %decentholograms% to %string%",
                    "insert [line] %integer% of [decenthologram] %decentholograms% to %string%",
                    "set [line] %integer% of [decenthologram] %decentholograms% to %string%"
            );
        }
    }
