...
@Examples({
        "remove page 2 of decenthologram \"test\""
})
@Since("1.0")
...
public class EffectHoloEditPage extends Effect {
    ...
    static{
        if (Bukkit.getServer().getPluginManager().isPluginEnabled("DecentHolograms")){
            Skript.registerEffect(EffectHoloEditPage.class,
                    "add [page] of [decenthologram] %decentholograms%",
                    "remove [page] %integer% of [decenthologram] %decentholograms%",
                    "insert [page] %integer% of [decenthologram] %decentholograms%"
            );
        }
    }
    ...
    public @NotNull String toString(@Nullable Event event, boolean debug) {
        return "edit decenthologram page";
    }
