...
@Examples({
        "send decenthologram facing of {_holo}"
})
@Since("1.0")
...
public class ExpressionHoloFacing extends PropertyExpression<Hologram, Number> {
    ...
    static {
        register(ExpressionHoloFacing.class, Number.class, "decenthologram facing", "decentholograms");
    }
    ...
    public @NotNull String toString(@Nullable Event event, boolean debug) {
        return "facing of decenthologram";
    }
